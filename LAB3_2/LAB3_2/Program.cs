...
namespace LAB3_2
{
    ...
    internal class Program
    {
        public static void Main(string[] args)
        {
            ...
            var house = new Building(2,150,3);
            var office = new Building(5, 500, 0);
            Console.WriteLine(house);
            Console.WriteLine(office);

            var carriage = new Carriage(100, 0);
            carriage.drive(70.0);
            Console.WriteLine(carriage);

            var automobile = new Automobile(100, 2);
            automobile.drive(5);
            Console.WriteLine(automobile);

            var airoplane = new Airplane(1000, 0);
            airoplane.drive(2);
            Console.WriteLine(airoplane);

            var boat = new Boat(200, 0);
            boat.drive(4);
